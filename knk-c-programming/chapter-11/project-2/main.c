...
void find_closest_flight(int desired_time, int *departure_time, int *arrival_time)
{
	int compare_with_past, compare_with_comming;

	if(desired_time < DEPARTURE_TIME_1) {
		//be carefull
		compare_with_past = (1440 - DEPARTURE_TIME_8) + desired_time;
		compare_with_comming = desired_time - DEPARTURE_TIME_1;
	...
	} else if(desired_time < DEPARTURE_TIME_2) {
		compare_with_past = desired_time - DEPARTURE_TIME_1;
		compare_with_comming = desired_time - DEPARTURE_TIME_2;
	...
	} else if(desired_time < DEPARTURE_TIME_3) {
		compare_with_past = desired_time - DEPARTURE_TIME_2;
		compare_with_comming = desired_time - DEPARTURE_TIME_3;
	...
	} else if(desired_time < DEPARTURE_TIME_4) {
		compare_with_past = desired_time - DEPARTURE_TIME_3;
		compare_with_comming = desired_time - DEPARTURE_TIME_4;
	...
	} else if(desired_time < DEPARTURE_TIME_5) {
		compare_with_past = desired_time - DEPARTURE_TIME_4;
		compare_with_comming = desired_time - DEPARTURE_TIME_5;
	...
	} else if(desired_time < DEPARTURE_TIME_6) {
		compare_with_past = desired_time - DEPARTURE_TIME_5;
		compare_with_comming = desired_time - DEPARTURE_TIME_6;
	...
	} else if(desired_time < DEPARTURE_TIME_7) {
		compare_with_past = desired_time - DEPARTURE_TIME_6;
		compare_with_comming = desired_time - DEPARTURE_TIME_7;
	...
	} else if(desired_time < DEPARTURE_TIME_8) {
		compare_with_past = desired_time - DEPARTURE_TIME_7;
		compare_with_comming = desired_time - DEPARTURE_TIME_8;
		...
		compare_with_past = desired_time - DEPARTURE_TIME_8;
		//be carefull
		compare_with_comming = (1440 - desired_time) + DEPARTURE_TIME_1;
